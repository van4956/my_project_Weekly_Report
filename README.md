...
1. страница отчета 1 - СОН.  Используются показатели начало сна, продолжительность быстрого и медленного сна, дневная активность, количестов шагов, общая оценка сна. корреляция оценки сна со временем медленого и быстрого сна, и дневной активности
 
 
| Страница отчета | Показатели и метрики | Описание | 
| :---------------------- | :---------------------- | :---------------------- |  
| СОН | Начало сна, продолжительность быстрого и медленного сна, дневная активность, количестов шагов, общая оценка сна, корреляция оценки сна со временем медленого и быстрого сна, и дневной активности | Ключевым показателем считаю время начала сна, очень важно что бы время отбоя и пробуждения было постоянным. Продолжительность медленного сна, так как именно во время него происходят самые важные процессы востановления организма. ,а так же общюю оценку сна |  
